...
def generate_segments(bounding_box: Tuple[int, int, int, int],
                      num_of_segments: int) -> List[Tuple[int, int, int, int]]:
    """Split window defined by limits into equally sized segments.
    Args:
        bounding_box (Tuple[int, int, int, int]): [minx, miny, maxx, maxy] of basemap
        num_of_segments (int): number of segments in 1 row and 1 column, final num is 2^x
    Returns:
        List[Tuple[int, int, int, int]]: List of segments, 1 segment defined by 4 limits
    """
...
def is_in_segment(street_bounds: Tuple[int, int, int, int],
                  segment_bounds: Tuple[int, int, int, int]) -> bool:
    """Checks if start of street lays in segment
    Args:
        street_bounds (Tuple[int, int, int, int]): bounds of street
        segment_bounds (Tuple[int, int, int, int]): bounds of a segment
    Returns:
...
def assign_segments_to_dataset(dataset: gpd.GeoDataFrame,
                               segment_matrix: List[Tuple[int, int, int, int]],
    ...
    Args:
        ...
        segment_matrix (List[Tuple[int, int, int, int]]): list generated by generate_segments fnc
